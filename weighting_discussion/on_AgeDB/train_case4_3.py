...
def demo(data_root, train_list, validate_list, test_list, save, n_epochs=1,
    ...
    if os.path.exists(os.path.join(save, 'el_resnet18_nesterov_3groups_case4_3.csv')):
        os.remove(os.path.join(save, 'el_resnet18_nesterov_3groups_case4_3.csv'))
    with open(os.path.join(save, 'el_resnet18_nesterov_3groups_case4_3.csv'), 'w') as f:
        f.write('******************************************************************\n')
...
#                                                         gamma=0.1)
    ...
    best_argmax_MAE = 100
    best_accuracy = 0
    model_state_name_1='el_resnet18_nesterov_3groups_model_case4_3_1.dat'
    model_state_dir_1=os.path.join(save, model_state_name_1)
    model_state_name_2='el_resnet18_nesterov_3groups_model_case4_3_2.dat'
    model_state_dir_2=os.path.join(save, model_state_name_2)
    
    with open(os.path.join(save, 'el_resnet18_nesterov_3groups_case4_3.csv'), 'a') as f:

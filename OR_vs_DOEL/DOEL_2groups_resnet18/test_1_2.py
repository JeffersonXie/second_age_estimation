...
# -*- coding: utf-8 -*-
"""
Created on Wed Apr  3 10:55:04 2019
...
def demo(data_root, test_list, save, batch_size=64, seed=None):
    ...
    if os.path.exists(os.path.join(save, 'ordinal_regression_resnet18_nesterov_results_test_1_2.csv')):
        os.remove(os.path.join(save, 'ordinal_regression_resnet18_nesterov_results_test_1_2.csv'))
    with open(os.path.join(save, 'ordinal_regression_resnet18_nesterov_results_test_1_2.csv'), 'w') as f:
        f.write('******************************************************************\n')
...
######################fold one#######################################
    ...
    if os.path.exists(model_state_dir_1):                   
        ...
        with open(os.path.join(save, 'ordinal_regression_resnet18_nesterov_results_test_1_2.csv'), 'a') as f:

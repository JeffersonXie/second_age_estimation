...
def demo(data_root, train_list, validate_list, test_list, save, n_epochs=1,
    ...
    if os.path.exists(os.path.join(save, 'el_resnet18_nesterov_two_group_results_train_1_5.csv')):
        os.remove(os.path.join(save, 'el_resnet18_nesterov_two_group_results_train_1_5.csv'))
    with open(os.path.join(save, 'el_resnet18_nesterov_two_group_results_train_1_5.csv'), 'w') as f:
        f.write('******************************************************************\n')
...
#                                                         gamma=0.1)
    ...
    model_state_name_2='el_resnet18_nesterov_two_group_model_1_5_2.dat'
    model_state_dir_2=os.path.join(save, model_state_name_2)
    
    with open(os.path.join(save, 'el_resnet18_nesterov_two_group_results_train_1_5.csv'), 'a') as f:

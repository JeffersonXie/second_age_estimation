...
def demo(data_root, test_list, save, batch_size=64, seed=None):
    ...
    if os.path.exists(os.path.join(save, 'ordinal_regression_resnet18_nesterov_results_consistency_broken_counting_1_1.csv')):
        os.remove(os.path.join(save, 'ordinal_regression_resnet18_nesterov_results_consistency_broken_counting_1_1.csv'))
    with open(os.path.join(save, 'ordinal_regression_resnet18_nesterov_results_consistency_broken_counting_1_1.csv'), 'w') as f:
        f.write('******************************************************************\n')
...
######################fold one#######################################
    ...
    if os.path.exists(model_state_dir_1):                   
        ...
        with open(os.path.join(save, 'ordinal_regression_resnet18_nesterov_results_consistency_broken_counting_1_1.csv'), 'a') as f:

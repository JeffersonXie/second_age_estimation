...
# -*- coding: utf-8 -*-
"""
Created on Wed Apr  3 15:49:14 2019
...
def demo(data_root, train_list, test_list, save, n_epochs=1,
    ...
    if os.path.exists(os.path.join(save, 'el_resnet101_nesterov_results_train_1.csv')):
        os.remove(os.path.join(save, 'el_resnet101_nesterov_results_train_1.csv'))
    with open(os.path.join(save, 'el_resnet101_nesterov_results_train_1.csv'), 'w') as f:
        f.write('******************************************************************\n')
...
#                                                         gamma=0.1)
    ...
    with open(os.path.join(save, 'el_resnet101_nesterov_results_train_1.csv'), 'a') as f:

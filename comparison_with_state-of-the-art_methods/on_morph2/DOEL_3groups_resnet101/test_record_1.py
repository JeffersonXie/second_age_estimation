...
# -*- coding: utf-8 -*-
"""
Created on Wed Jul  3 11:32:58 2019
...
def demo(data_root, test_list, save, batch_size=64, seed=None):
    ...
    if os.path.exists(os.path.join(save, 'el_resnet101_nesterov_results_train_testing_record_1.csv')):
        os.remove(os.path.join(save, 'el_resnet101_nesterov_results_train_testing_record_1.csv'))
    with open(os.path.join(save, 'el_resnet101_nesterov_results_train_testing_record_1.csv'), 'w') as f:
        f.write('******************************************************************\n')
...
#    with open(os.path.join(save, 'el_resnet101_nesterov_results_train_testing_record_1.csv'), 'a') as f:
#        f.write('image_name, true_age, predict_age, AE:\n')
#    for i in range(len(test_lists_record)):
...
#            f.write('%s\n' % (img_name))    
    ...
    model_state_name_1='el_resnet101_nesterov_train_model_1.dat'

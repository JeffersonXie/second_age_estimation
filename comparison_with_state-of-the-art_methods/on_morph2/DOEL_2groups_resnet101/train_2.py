...
# -*- coding: utf-8 -*-
"""
Created on Fri Jul  5 15:35:04 2019
...
from ensemble_learning_resnet_two_group_morph2 import el_resnet101
...
def demo(data_root, train_list, test_list, save, n_epochs=1,
    ...
    if os.path.exists(os.path.join(save, 'el_resnet101_2groups_nesterov_results_2.csv')):
        os.remove(os.path.join(save, 'el_resnet101_2groups_nesterov_results_2.csv'))
    with open(os.path.join(save, 'el_resnet101_2groups_nesterov_results_2.csv'), 'w') as f:
        f.write('******************************************************************\n')
...
#                                                         gamma=0.1)
    ...
    best_argmax_MAE = 100
    model_state_name_1='el_resnet101_nesterov_2groups_model_2.dat'
    model_state_dir_1=os.path.join(save, model_state_name_1)

    
    with open(os.path.join(save, 'el_resnet101_2groups_nesterov_results_2.csv'), 'a') as f:

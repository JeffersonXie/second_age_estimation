...
#      batch_size=64, lr=0.001, wd=0.0005, seed=None):
    ...
    if os.path.exists(os.path.join(save, 'argmax_exp_cross_entropy_ResNet18_nesterov_results_3_1.csv')):
        os.remove(os.path.join(save, 'argmax_exp_cross_entropy_ResNet18_nesterov_results_3_1.csv'))
    with open(os.path.join(save, 'argmax_exp_cross_entropy_ResNet18_nesterov_results_3_1.csv'), 'w') as f:
        f.write('******************************************************************\n')
...
#                                                         gamma=0.1)
    ...
    model_state_name_1='argmax_resnet18_nesterov_model_3_1_1.dat'
    model_state_name_2='exp_resnet18_nesterov_model_3_1_2.dat'
    model_state_name_3='round_exp_resnet18_nesterov_model_3_1_3.dat'
    ...
    with open(os.path.join(save, 'argmax_exp_cross_entropy_ResNet18_nesterov_results_3_1.csv'), 'a') as f:

...
# -*- coding: utf-8 -*-
"""
Created on Sun Mar 24 20:12:39 2019
...
#      batch_size=64, lr=0.001, wd=0.0005, seed=None):
    ...
    if os.path.exists(os.path.join(save, 'regression_mae_ResNet18_nesterov_results_2_2.csv')):
        os.remove(os.path.join(save, 'regression_mae_ResNet18_nesterov_results_2_2.csv'))
    with open(os.path.join(save, 'regression_mae_ResNet18_nesterov_results_2_2.csv'), 'w') as f:
        f.write('******************************************************************\n')
...
#                                                     gamma=0.1)
    ...
    best_MAE = 100
    model_state_name_1='regression_mae_resnet18_nesterov_model_2_2.dat'
    model_state_dir_1=os.path.join(save, model_state_name_1)

    
    with open(os.path.join(save, 'regression_mae_ResNet18_nesterov_results_2_2.csv'), 'a') as f:

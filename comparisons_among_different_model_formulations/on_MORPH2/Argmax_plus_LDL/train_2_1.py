...
# -*- coding: utf-8 -*-
"""
Created on Mon Jan 21 19:24:22 2019
...
def train(model, loader, optimizer, epoch, n_epochs, device, print_freq=1):
    ...
    for batch_idx, (input, target) in enumerate(loader):
        ...
        loss=KLloss(new_output, target_var[:,0:101])/batch_size
...
def demo(data_root, train_list, validate_list, test_list, save, n_epochs=1,
    ...
    if os.path.exists(os.path.join(save, 'DLDL_ResNet18_nesterov_results_2_1.csv')):
        os.remove(os.path.join(save, 'DLDL_ResNet18_nesterov_results_2_1.csv'))
    with open(os.path.join(save, 'DLDL_ResNet18_nesterov_results_2_1.csv'), 'w') as f:
        f.write('******************************************************************\n')
...
#    # Train and validate model
    best_argmax_MAE = 100
    best_exp_MAE = 100
    model_state_name_1='DLDL_resnet18_nesterov_model_2_1_1.dat'
    model_state_name_2='DLDL_resnet18_nesterov_model_2_1_2.dat'
    model_state_dir_1=os.path.join(save, model_state_name_1)
    model_state_dir_2=os.path.join(save, model_state_name_2)
    
    with open(os.path.join(save, 'DLDL_ResNet18_nesterov_results_2_1.csv'), 'a') as f:

...
def demo(data_root, train_list, validate_list, test_list, save, n_epochs=1,
    ...
    if os.path.exists(os.path.join(save, 'DLDL_ResNet18_nesterov_results_1_1.csv')):
        os.remove(os.path.join(save, 'DLDL_ResNet18_nesterov_results_1_1.csv'))
    with open(os.path.join(save, 'DLDL_ResNet18_nesterov_results_1_1.csv'), 'w') as f:
        f.write('******************************************************************\n')
...
#    # Train and validate model
    ...
    with open(os.path.join(save, 'DLDL_ResNet18_nesterov_results_1_1.csv'), 'a') as f:

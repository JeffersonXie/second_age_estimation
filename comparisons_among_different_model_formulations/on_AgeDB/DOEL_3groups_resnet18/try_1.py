...
# -*- coding: utf-8 -*-
"""
Created on Tue Mar 26 16:07:50 2019
...
from ensemble_learning_resnet import el_resnet101
...
def demo(data_root, train_list, validate_list, test_list, save, n_epochs=1,
    ...
    if os.path.exists(os.path.join(save, 'ensemble_learning_resnet18_nesterov_try_1.csv')):
        os.remove(os.path.join(save, 'ensemble_learning_resnet18_nesterov_try_1.csv'))
    with open(os.path.join(save, 'ensemble_learning_resnet18_nesterov_try_1.csv'), 'w') as f:
        f.write('******************************************************************\n')
...
#                                                         gamma=0.1)
    ...
    best_argmax_MAE = 100
    best_accuracy = 0
    model_state_name_1='ensemble_learning_resnet18_nesterov_try_model_1_1.dat'
    model_state_dir_1=os.path.join(save, model_state_name_1)
    model_state_name_2='ensemble_learning_resnet18_nesterov_try_model_1_2.dat'
    model_state_dir_2=os.path.join(save, model_state_name_2)
    
    with open(os.path.join(save, 'ensemble_learning_resnet18_nesterov_try_1.csv'), 'a') as f:

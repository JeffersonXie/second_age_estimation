...
# -*- coding: utf-8 -*-
"""
Created on Wed Mar 27 11:15:41 2019
...
def demo(data_root, train_list, validate_list, test_list, save, n_epochs=1,
    ...
    if os.path.exists(os.path.join(save, 'DLDL_ResNet18_nesterov_results_train_1_5.csv')):
        os.remove(os.path.join(save, 'DLDL_ResNet18_nesterov_results_train_1_5.csv'))
    with open(os.path.join(save, 'DLDL_ResNet18_nesterov_results_train_1_5.csv'), 'w') as f:
        f.write('******************************************************************\n')
...
#    # Train and validate model
    best_argmax_MAE = 100
    best_exp_MAE = 100
    model_state_name_1='DLDL_resnet18_nesterov_model_train_1_5_1.dat'
    model_state_name_2='DLDL_resnet18_nesterov_model_train_1_5_2.dat'
    model_state_dir_1=os.path.join(save, model_state_name_1)
    model_state_dir_2=os.path.join(save, model_state_name_2)
    
    with open(os.path.join(save, 'DLDL_ResNet18_nesterov_results_train_1_5.csv'), 'a') as f:

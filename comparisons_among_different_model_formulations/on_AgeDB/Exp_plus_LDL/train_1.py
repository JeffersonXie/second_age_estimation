...
# -*- coding: utf-8 -*-
"""
Created on Sat Mar 30 14:27:53 2019
...
#      batch_size=64, lr=0.001, wd=0.0005, seed=None):
    ...
    if os.path.exists(os.path.join(save, 'DLDL_expectation_ResNet18_nesterov_results_1.csv')):
        os.remove(os.path.join(save, 'DLDL_expectation_ResNet18_nesterov_results_1.csv'))
    with open(os.path.join(save, 'DLDL_expectation_ResNet18_nesterov_results_1.csv'), 'w') as f:
        f.write('******************************************************************\n')
...
#                                                         gamma=0.1)
    ...
    best_exp_MAE = 100
    model_state_name='DLDL_expection_resnet18_nesterov_model_1.dat'
    model_state_dir=os.path.join(save, model_state_name)
    
    with open(os.path.join(save, 'DLDL_expectation_ResNet18_nesterov_results_1.csv'), 'a') as f:

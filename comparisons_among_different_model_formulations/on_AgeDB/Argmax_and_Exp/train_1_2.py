...
# -*- coding: utf-8 -*-
"""
Created on Tue Mar 26 20:14:52 2019
...
#      batch_size=64, lr=0.001, wd=0.0005, seed=None):
    ...
    if os.path.exists(os.path.join(save, 'argmax_exp_cross_entropy_ResNet18_nesterov_train_1_2.csv')):
        os.remove(os.path.join(save, 'argmax_exp_cross_entropy_ResNet18_nesterov_train_1_2.csv'))
    with open(os.path.join(save, 'argmax_exp_cross_entropy_ResNet18_nesterov_train_1_2.csv'), 'w') as f:
        f.write('******************************************************************\n')
...
#                                                         gamma=0.1)
    ...
    best_argmax_MAE = 100
    best_exp_MAE = 100
    model_state_name_1='argmax_resnet18_nesterov_train_model_1_2_1.dat'
    model_state_name_2='exp_resnet18_nesterov_train_model_1_2_2.dat'
    model_state_dir_1=os.path.join(save, model_state_name_1)
    model_state_dir_2=os.path.join(save, model_state_name_2)
    
    with open(os.path.join(save, 'argmax_exp_cross_entropy_ResNet18_nesterov_train_1_2.csv'), 'a') as f:

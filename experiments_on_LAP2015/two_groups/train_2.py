...
# -*- coding: utf-8 -*-
"""
Created on Thu Nov 28 17:47:24 2019
...
#    model_state_dir_1=os.path.join(save, model_state_name_1)
    ...
    model_state_name_1='el_resnet101_nesterov_2groups_model_Chalearn_LAP2015_2_1.dat'
    model_state_dir_1=os.path.join(save, model_state_name_1)
    model_state_name_2='el_resnet101_nesterov_2groups_model_Chalearn_LAP2015_2_2.dat'
    model_state_dir_2=os.path.join(save, model_state_name_2)
    model_state_name_3='el_resnet101_nesterov_2groups_model_Chalearn_LAP2015_2_3.dat'

...
# -*- coding: utf-8 -*-
"""
Created on Tue Nov 26 11:06:34 2019
...
from ensemble_learning_resnet_two_group_imdb_wiki import el_resnet101
...
def demo(data_root, train_list, validate_list, save, n_epochs=1,
    ...
    if os.path.exists(os.path.join(save, 'el_resnet101_2groups_nesterov_results_1.csv')):
        os.remove(os.path.join(save, 'el_resnet101_2groups_nesterov_results_1.csv'))
    with open(os.path.join(save, 'el_resnet101_2groups_nesterov_results_1.csv'), 'w') as f:
        f.write('******************************************************************\n')
...
#    model_state_dir_1=os.path.join(save, model_state_name_1)
    ...
    with open(os.path.join(save, 'el_resnet101_2groups_nesterov_results_1.csv'), 'a') as f:

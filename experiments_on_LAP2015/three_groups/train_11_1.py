...
# -*- coding: utf-8 -*-
"""
Created on Sun Nov 24 12:58:25 2019
...
from Dataset_folder import Dataset_folder as data_prepare
from ensemble_learning_resnet_three_group_Chalearn_2015 import el_resnet101
...
#            print(res)
    ...
    return batch_time.avg, total_loss.avg, cross_entropy_loss.avg, kl_loss.avg, argmax_MAE.avg, epsilon_error.avg, accuracy.avg
...
#                print(res)
        ...
        # Return summary statistics
        return batch_time.avg, total_loss.avg, cross_entropy_loss.avg, kl_loss.avg, argmax_MAE.avg, epsilon_error.avg, accuracy.avg, AE_list, predict_age_list, real_age_list
...
#            os._exit(0)
        ...
        for i in range(0,batch_size):
            tmp_epsilon_error+=1-math.exp(-math.pow((predicted_ages[i].float()-target[i,396]),2)/(2*math.pow(target[i,397],2)))
...
def demo(data_root, train_list, test_list, save, n_epochs=1,
    ...
    if os.path.exists(os.path.join(save, 'el_resnet101_nesterov_results_train_11_1.csv')):
        os.remove(os.path.join(save, 'el_resnet101_nesterov_results_train_11_1.csv'))
    with open(os.path.join(save, 'el_resnet101_nesterov_results_train_11_1.csv'), 'w') as f:
        f.write('******************************************************************\n')
        f.write('records on Chaleran LAP 2015 dataset\n')
        f.write('******************************************************************\n')
        f.write('\n')
        f.write('\n')
...
#    ensemble_learning_model.load_state_dict(torch.load('./el_resnet101_nesterov_train_model_IMDB_WIKI_1_1.dat'))
    ...
    model_wrapper.load_state_dict(torch.load('./el_resnet101_nesterov_train_model_IMDB_WIKI_1_1.dat'))
...
#    best_argmax_MAE = 100
#    model_state_name_1='el_resnet101_nesterov_train_model_Chalearn_LAP2015_1.dat'
#    model_state_dir_1=os.path.join(save, model_state_name_1)

    best_argmax_MAE = 100
    best_accuracy=0
    best_epsilon_error=1
    model_state_name_1='el_resnet101_nesterov_train_model_Chalearn_LAP2015_11_1.dat'
    model_state_dir_1=os.path.join(save, model_state_name_1)
    model_state_name_2='el_resnet101_nesterov_train_model_Chalearn_LAP2015_11_2.dat'
    model_state_dir_2=os.path.join(save, model_state_name_2)
    model_state_name_3='el_resnet101_nesterov_train_model_Chalearn_LAP2015_11_3.dat'
    ...
    with open(os.path.join(save, 'el_resnet101_nesterov_results_train_11_1.csv'), 'a') as f:
        f.write('epoch, train_total_loss, train_cross_entropy_loss, train_kl_loss, train_argmax_MAE, train_epsilon_error, train_accuracy\n')

    for epoch in range(n_epochs):

        scheduler.step()
        _, train_total_loss, train_cross_entropy_loss, train_kl_loss, train_argmax_MAE, train_epsilon_error, train_accuracy = train(
            model=model_wrapper,
            loader=train_loader,
            optimizer=optimizer,
            epoch=epoch,
...
#         Determine if model is the best
        ...
        with open(os.path.join(save, 'el_resnet101_nesterov_results_train_11_1.csv'), 'a') as f:
            f.write('%03d, %0.4f, %0.4f, %0.4f, %0.4f, %0.4f, %0.4f\n'
                    % ((epoch + 1), train_total_loss, train_cross_entropy_loss, train_kl_loss, train_argmax_MAE, train_epsilon_error, train_accuracy))
    ...
    # Test model       
    if os.path.exists(model_state_dir_1):                   
        _, test_total_loss, test_cross_entropy_loss, test_kl_loss, test_argmax_MAE, test_epsilon_error, test_accuracy, AE_list, predict_age_list, real_age_list= test_1(
            model=model_wrapper,
...
#        os.remove(model_state_dir_1)
        with open(os.path.join(save, 'el_resnet101_nesterov_results_train_11_1.csv'), 'a') as f:
            f.write('test_total_loss, test_cross_entropy_loss, test_kl_loss, test_argmax_MAE, test_epsilon_error, test_accuracy:\n')
            f.write('%0.4f, %0.4f, %0.4f, %0.4f, %0.4f, %0.4f\n' % (test_total_loss, test_cross_entropy_loss, test_kl_loss, test_argmax_MAE, test_epsilon_error, test_accuracy))
#            f.write('\n') 
...
#            f.write('\n') 
    ...
    if os.path.exists(model_state_dir_1):                   
        _, test_total_loss, test_cross_entropy_loss, test_kl_loss, test_argmax_MAE, test_epsilon_error, test_accuracy, AE_list, predict_age_list, real_age_list= test_2(
            model=model_wrapper,

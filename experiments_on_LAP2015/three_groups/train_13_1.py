...
# -*- coding: utf-8 -*-
"""
Created on Sun Nov 24 14:27:10 2019
...
def demo(data_root, train_list, test_list, save, n_epochs=1,
    ...
    if os.path.exists(os.path.join(save, 'el_resnet101_nesterov_results_train_13_1.csv')):
        os.remove(os.path.join(save, 'el_resnet101_nesterov_results_train_13_1.csv'))
    with open(os.path.join(save, 'el_resnet101_nesterov_results_train_13_1.csv'), 'w') as f:
        f.write('******************************************************************\n')
...
#    model_state_dir_1=os.path.join(save, model_state_name_1)
    ...
    model_state_name_1='el_resnet101_nesterov_train_model_Chalearn_LAP2015_13_1.dat'
    model_state_dir_1=os.path.join(save, model_state_name_1)
    model_state_name_2='el_resnet101_nesterov_train_model_Chalearn_LAP2015_13_2.dat'
    model_state_dir_2=os.path.join(save, model_state_name_2)
    model_state_name_3='el_resnet101_nesterov_train_model_Chalearn_LAP2015_13_3.dat'
    ...
    with open(os.path.join(save, 'el_resnet101_nesterov_results_train_13_1.csv'), 'a') as f:

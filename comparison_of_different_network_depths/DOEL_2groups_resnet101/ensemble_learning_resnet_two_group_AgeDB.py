...
# -*- coding: utf-8 -*-
"""
Created on Thu Mar 28 11:33:55 2019
...
class ResNet(nn.Module):
    ...
    def __init__(self, block, layers, num_classes=3, zero_init_residual=False):
        ...
        self.classifier101 = nn.Linear(512 * block.expansion, num_classes)
#
    ...
    def forward(self, x):
        ...
        out=torch.cat((x1,x2,x3,x4,x5,x6,x7,x8,x9,x10,x11,x12,x13,x14,x15,x16,x17,x18,x19,
             ...
             x80,x81,x82,x83,x84,x85,x86,x87,x88,x89,x90,x91,x92,x93,x94,x95,x96,x97,x98,x99,x100,x101), 1)    

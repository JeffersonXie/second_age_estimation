...
# -*- coding: utf-8 -*-
"""
Created on Wed Mar 27 10:03:34 2019
...
def demo(data_root, train_list, validate_list, test_list, save, n_epochs=1,
    ...
    if os.path.exists(os.path.join(save, 'el_resnet101_nesterov_three_group_train_1_1.csv')):
        os.remove(os.path.join(save, 'el_resnet101_nesterov_three_group_train_1_1.csv'))
    with open(os.path.join(save, 'el_resnet101_nesterov_three_group_train_1_1.csv'), 'w') as f:
        f.write('******************************************************************\n')
...
#                                                         gamma=0.1)
    ...
    model_state_name_2='el_resnet101_nesterov_three_group_model_1_1_2.dat'
    model_state_dir_2=os.path.join(save, model_state_name_2)
    
    with open(os.path.join(save, 'el_resnet101_nesterov_three_group_train_1_1.csv'), 'a') as f:
